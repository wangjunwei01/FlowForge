...
| # | 验收项 | 通过条件 | 结果 | 测试日期 | 备注 |
|---|--------|----------|------|----------|------|
| 1 | Cookie 管理 | Cookie 自动提取和跨请求传递 | ⬜ | | |
| 2 | 代理 | HTTP/SOCKS5 代理可正确工作 | ⬜ | | |
| 3 | SSL/TLS | 客户端证书和无验证选项可工作 | ⬜ | | |
